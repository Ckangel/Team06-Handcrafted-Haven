      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <form onSubmit={handleCredentialsLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#F8333C] text-white font-medium py-2.5 rounded-lg hover:opacity-90 transition disabled:opacity-50"
          >
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-neutralLight" />}>
      <LoginPageContent />
    </Suspense>
  );
}
