      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#44AF69] text-white font-medium py-2.5 rounded-lg hover:opacity-90 transition disabled:opacity-50"
          >
        ...
        <div className="flex gap-4">
          <button
            type="button"
            disabled
            title="Sign up with GitHub is currently not available"
            className="flex-1 flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-2.5 transition opacity-60 cursor-not-allowed"
          >
          ...
          <button
            type="button"
            disabled
            title="Sign up with Google is currently not available"
            className="flex-1 flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-2.5 transition opacity-60 cursor-not-allowed"
          >
