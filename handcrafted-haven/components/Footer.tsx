    ...
    <footer className="w-full bg-gradient-to-br from-[#2b9eb3] to-[#1e7a8a]">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 pb-12 border-b border-white/20">
          {/* Logo & Tagline */}
          <div>
            <Link href="/" className="flex items-center gap-3 group" title="Handcrafted Haven - Home">
        ...
        <div className="grid grid-cols-2 gap-8 pt-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/80">
              <li>
                <Link href="/shop" className="hover:text-white hover:pl-1 transition-all flex items-center gap-2" title="Browse all products">
                  <span className="w-1 h-1 bg-[#fcab10] rounded-full"></span>
                  All Products
                </Link>
              </li>
              <li>
                <Link href="/categories" className="hover:text-white hover:pl-1 transition-all flex items-center gap-2" title="Browse categories">
                  <span className="w-1 h-1 bg-[#fcab10] rounded-full"></span>
                  Categories
                </Link>
              </li>
              <li>
                <Link href="/cart" className="hover:text-white hover:pl-1 transition-all flex items-center gap-2" title="View your cart">
                  <span className="w-1 h-1 bg-[#fcab10] rounded-full"></span>
                  Your Cart
                </Link>
              </li>
              <li>
                <Link href="/wishlist" className="hover:text-white hover:pl-1 transition-all flex items-center gap-2" title="View your wishlist">
                  <span className="w-1 h-1 bg-[#fcab10] rounded-full"></span>
                  Wishlist
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/80">
              <li>
                <Link href="/artisans" className="hover:text-white hover:pl-1 transition-all flex items-center gap-2" title="Meet the artisans">
                  <span className="w-1 h-1 bg-[#44AF69] rounded-full"></span>
                  Meet the Makers
                </Link>
              </li>
              <li>
                <Link href="/dashboard" className="hover:text-white hover:pl-1 transition-all flex items-center gap-2" title="Seller dashboard">
                  <span className="w-1 h-1 bg-[#44AF69] rounded-full"></span>
                  Seller Dashboard
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/80">
              <li>
                <Link href="/account" className="hover:text-white hover:pl-1 transition-all flex items-center gap-2" title="Manage your account">
                  <span className="w-1 h-1 bg-[#f8333c] rounded-full"></span>
                  My Account
                </Link>
              </li>
              <li>
                <Link href="/orders" className="hover:text-white hover:pl-1 transition-all flex items-center gap-2" title="View your orders">
                  <span className="w-1 h-1 bg-[#f8333c] rounded-full"></span>
                  Order History
                </Link>
              </li>
              <li>
                <Link href="/login" className="hover:text-white hover:pl-1 transition-all flex items-center gap-2" title="Sign in">
                  <span className="w-1 h-1 bg-[#f8333c] rounded-full"></span>
                  Sign In
                </Link>
              </li>
              <li>
                <Link href="/signup" className="hover:text-white hover:pl-1 transition-all flex items-center gap-2" title="Create an account">
                  <span className="w-1 h-1 bg-[#f8333c] rounded-full"></span>
                  Create Account
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/80">
              <li>
                <Link href="/about" className="hover:text-white hover:pl-1 transition-all flex items-center gap-2" title="About Handcrafted Haven">
                  <span className="w-1 h-1 bg-white/60 rounded-full"></span>
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/checkout" className="hover:text-white hover:pl-1 transition-all flex items-center gap-2" title="Checkout">
                  <span className="w-1 h-1 bg-white/60 rounded-full"></span>
                  Checkout
                </Link>
              </li>
